...
class TSizes {
   ...
   static double iconsXs = 12.0;
   static double iconsSm = 16.0;
   static double iconsMd = 24.0;
   static double iconsLg = 32.0;
   ...
   static double defaultSpace = 14.0;
   ...
   static double productImageWidth = 160.0;
